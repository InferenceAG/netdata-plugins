...
SCRIPT_FILE="BITCOIN_BITCOIN_NETWORK.chart.py"
CONFIG_FILE="BITCOIN_BITCOIN_NETWORK.conf"
HEALTH_FILE="BITCOIN_BITCOIN_NETWORK.health.conf"
...
#	ETC_DIR=$(dirname $2)
	...
	echo "It will install BITCOIN module to netdata daemon (or update it)"
